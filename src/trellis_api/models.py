...
class StatusResponse(TrellisModel):
...
class ErrorResponse(TrellisModel):
...
class IngestResponse(TrellisModel):
...
class SearchRequest(TrellisModel):
...
class PackRequest(TrellisModel):
...
class PackResponse(TrellisModel):
...
class PromoteRequest(TrellisModel):
...
class LinkRequest(TrellisModel):
...
class EntityCreateRequest(TrellisModel):
...
class FeedbackRequest(TrellisModel):
...
class CommandResponse(TrellisModel):
...
class BatchCommandItem(TrellisModel):
...
class BatchCommandRequest(TrellisModel):
...
class BatchCommandResponse(TrellisModel):
...
class BulkAliasItem(TrellisModel):
...
class BulkIngestRequest(TrellisModel):
...
class BulkItemResult(TrellisModel):
...
class BulkGroupResult(TrellisModel):
...
class BulkIngestResponse(TrellisModel):
...
class HealthResponse(TrellisModel):
...
class StatsResponse(TrellisModel):
