...
use to call LLMs and embed text.  Reference implementations for specific
providers live in ``trellis.llm.providers`` and are gated behind optional
extras (``[llm-openai]``, ``[llm-anthropic]``).
"""
