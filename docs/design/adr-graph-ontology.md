...
**Related:**
- [`./adr-enterprise-ontology-capability-framing.md`](./adr-enterprise-ontology-capability-framing.md) — umbrella framing (#217) that situates this open-string ontology alongside enterprise-graph (EG) profiles, lineage, and agent memory
