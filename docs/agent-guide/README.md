...
| [pack-quality-evaluation.md](pack-quality-evaluation.md) | Assembly-time pack scoring — six dimensions (one opt-in via `expected_shapes`), built-in profiles, scenario fixtures, optional `PackBuilder` hook |
